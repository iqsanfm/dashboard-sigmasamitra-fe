...
const EditMonthlyJobPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setJobName(client ? `${client.client_name} - Monthly` : `Job ID: ${job_id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`/dashboard/jobs/monthly/${job_id}`);
    } catch (err) {
...
export default EditMonthlyJobPage;
