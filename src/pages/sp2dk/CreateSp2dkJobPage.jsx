...
const CreateSp2dkJobPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showNotification(`Error: ${err.message || 'Gagal membuat pekerjaan SP2DK.'}`, 'error');
    } finally {
      setLoading(false);
    }
  };
...
export default CreateSp2dkJobPage;
